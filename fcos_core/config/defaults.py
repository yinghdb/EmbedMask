...
_C.MODEL.EMBED_MASK.BOX_PADDING = -1.0
...
_C.MODEL.EMBED_MASK.MARGIN_REDUCE_FACTOR = 32
_C.MODEL.EMBED_MASK.EMBED_REDUCE_FACTOR = 1

# inference settings
_C.MODEL.EMBED_MASK.MASK_TH = 0.53
_C.MODEL.EMBED_MASK.POSTPROCESS_MASKS = False
_C.MODEL.EMBED_MASK.KEEP_EMBED = False
